...
export function setupAssociations() {
	...
	Resident.hasOne(BillingAddress, {
		foreignKey: "resident_id",
		as: "billing_address",
	});
	BillingAddress.belongsTo(Resident, {
		foreignKey: "resident_id",
		as: "resident",
	});

	// Resident and Insurance associations (one-to-many)
	Resident.hasMany(Insurance, { foreignKey: "resident_id", as: "insurances" });
	Insurance.belongsTo(Resident, { foreignKey: "resident_id", as: "resident" });
}
